import { Action, EpisodeSnapshot, GameConfiguration, GameState, PlayerValues } from "game";
...
export interface Model<C extends GameConfiguration, S extends GameState, A extends Action, EncodedSampleT> {
...
export interface InferenceModel<C extends GameConfiguration, S extends GameState, A extends Action> {
...
export interface TrainingModel<C extends GameConfiguration, S extends GameState, A extends Action, EncodedSampleT> {
